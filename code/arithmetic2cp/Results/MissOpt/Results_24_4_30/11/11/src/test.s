	.text
	.file	"test.cpp"
	.globl	_Z3fn1bbbhbbbbbbb               # -- Begin function _Z3fn1bbbhbbbbbbb
	.p2align	4, 0x90
	.type	_Z3fn1bbbhbbbbbbb,@function
_Z3fn1bbbhbbbbbbb:                      # @_Z3fn1bbbhbbbbbbb
	.cfi_startproc
# %bb.0:
	testl	%ecx, %ecx
	...
	retq
.Lfunc_end0:
	.size	_Z3fn1bbbhbbbbbbb, .Lfunc_end0-_Z3fn1bbbhbbbbbbb
	.cfi_endproc
                                        # -- End function
